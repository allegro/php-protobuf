            ...
            if (is_null($namespace)) {
                ...
                if (isset($exists)) {
                    ...
                    $field->setTypeDescriptor(
                        $this->_namespaces[$file->getPackage()][$typeName]
                    );
                ...
                if ($exists) {
                    ...
                    $field->setTypeDescriptor(
                        $this->_namespaces[self::GLOBAL_NAMESPACE][$typeName]
                    );
                ...
                if (!isset($this->_namespaces[$namespace][$typeName])) {
                    throw new \Exception(
                        'Type ' . $typeName . ' not defined in ' . $namespace
                    );
                }

                $field->setTypeDescriptor(
                    $this->_namespaces[$namespace][$typeName]
                );

            } else {
                $type = $descriptor->findType(
                    $typeName, $field->getNamespace()
                );
                ...
                $exists = isset($this->_namespaces[$namespace][$typeName]);
